...
public class red_p6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_red_p6);

        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        theEnd = (Button) findViewById(R.id.the_end_6);
    ...
    public void play_6 (View view)
    {
        if (player == null)
        {
            player = MediaPlayer.create(this, R.raw.red_p6);
