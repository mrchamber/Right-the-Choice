...
public class arthur_c9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arthur_c9);

        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        cave = (Button) findViewById(R.id.enter);
        mt = (Button) findViewById(R.id.mountain);
    ...
    {
        Intent intent = new Intent(this, arthur_c17.class);
    ...
    public void play_ac9 (View view)
    {
        if (player == null)
        {
            player = MediaPlayer.create(this, R.raw.realm_c9);
    ...
    public void pause_ac9 (View view)
    {
        if (player != null)
        {
            player.pause();
    ...
    public void stop_ac9 (View view)
    {
        stopPlayer();
    }
